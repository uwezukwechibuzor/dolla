...
const (
	Query_Params_FullMethodName  = "/dollar.dollar.Query/Params"
	Query_Post_FullMethodName    = "/dollar.dollar.Query/Post"
	Query_PostAll_FullMethodName = "/dollar.dollar.Query/PostAll"
)
